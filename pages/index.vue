            ...
            <Transition name="fade">
              ...
              >
                <form @submit.prevent="submitDestination" class="space-y-4">
                  <div>
                    <label class="block mb-1 text-sm font-medium text-slate-700">Départ</label>
                    <input
                      type="text"
                      v-model="departure"
                  ...
                  <div>
                    <label class="block mb-1 text-sm font-medium text-slate-700">Destination / Direction</label>
                    <input
                      type="text"
                      v-model="destination"
